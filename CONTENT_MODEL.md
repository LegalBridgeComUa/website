...
Example:
Готовий документ в паперовому вигляді (оригінал документа) для подальшого використання за кордоном.
...
- фото / скан першої сторінки закордонного паспорта (у разі необхідності перекладу — для коректної транслітерації прізвище та ім'я)
